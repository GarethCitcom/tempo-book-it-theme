 ...
 * Slug: tempo-studio-manager/front-page-hero
 * Categories: featured
...
<h1 class="wp-block-heading"><?php echo esc_html__( 'Welcome to the booking portal', 'tempo-studio-manager' ); ?></h1>
<!-- /wp:heading -->
...
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="/book-classes/"><?php echo esc_html__( 'Book classes', 'tempo-studio-manager' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->
