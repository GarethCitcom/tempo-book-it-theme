			...
			<section class="tempo-login__form-panel">
				<div class="tempo-login__form-wrap">
					...
					<?php if ( in_array( ( isset( $_GET['error'] ) ? sanitize_key( wp_unslash( $_GET['error'] ) ) : '' ), array( 'invalidkey', 'expiredkey' ), true ) ) : ?>
						<div class="tempo-login__notice tempo-login__notice--error" role="alert"><span aria-hidden="true">!</span><p><?php esc_html_e( 'That reset link has expired or was already used. Request a new one below.', 'tempo-book-it-theme' ); ?></p></div>
					<?php endif; ?>
